...
if __name__ == '__main__':
	...
	proc = subprocess.Popen(['.' + os.sep + 'bmc.py', 'asset-history', '10000'],stdout=subprocess.PIPE,)
	stdout_value = proc.communicate()[0]

	# Remove all superfluous data
	stdout_value = stdout_value.replace('asset_id --:-- ', '')
	...
	print 'Asset_id,Time,Transaction,Type,Quantity'     # Output CSV heading
